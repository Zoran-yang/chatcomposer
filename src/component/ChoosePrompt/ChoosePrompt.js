...
function ChoosePrompt({handleNext, handleCopiedPrompt, activeStep, TabName, handleIsEnglish, switchLanguage, isEnglish, FavoritePrompt, promptDetailAndState, setFavoritePrompt, setPromptDetailAndState}){
  return(
    <>
