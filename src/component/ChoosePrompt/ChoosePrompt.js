...
function ChoosePrompt({handleNext, setCopiedPromptFunc, activeStep, TabName, handleIsEnglish, isEnglish, setPromptToMyFavorite, FavoritePrompt, handleFavoritePrompt}){
  return(
    <>
