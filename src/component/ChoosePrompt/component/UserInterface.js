    ...
    <Box sx={{ width: "100%" }}>
      ...
      <TabPanel value={value} index={0}>
        ...
        <div>
          <span>
            Reference :{" "}
            <a href="https://www.explainthis.io/zh-hant/chatgpt">
              ChatGPT 指令大全
            </a>
          </span>
        </div>
        <div>
          <span>
            Come from :{" "}
            <a href="https://www.explainthis.io/zh-hant">ExplainThis</a> Great
            website for frontend and backend info. Highly recommended resource
            for expanding development knowledge.{" "}
          </span>
        </div>
      </TabPanel>
